...
class TireService extends StatefulWidget {
  TireService({Key key}) : super(key: key);
                ...
                child: Container(
                  ...
                  child: FutureBuilder(
                    future: DefaultAssetBundle.of(context)
                        .loadString('assets/json/tire_services.json'),
                      ...
                      return GridView.count(
                        ...
                        children: List.generate(myData.length, (index) {
                          return GestureDetector(
                            onTap: () {
                              if (vehicleType.contains(myData[index]['type'])) {
                                setState(() {
                                  vehicleType.remove(myData[index]['type']);
                                });
                              } else {
                                setState(() {
                                  vehicleType.add(myData[index]['type']);
                                });
                              }
                            },
                            child: Padding(
