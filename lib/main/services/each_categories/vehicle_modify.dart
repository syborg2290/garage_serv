...
class VehicleModify extends StatefulWidget {
  VehicleModify({Key key}) : super(key: key);

  @override
  _VehicleModifyState createState() => _VehicleModifyState();
}

class _VehicleModifyState extends State<VehicleModify> {
  List vehicleType = [];
                  ...
                  child: Container(
                    ...
                    child: FutureBuilder(
                        future: DefaultAssetBundle.of(context)
                            .loadString('assets/json/vehicle_modify.json'),
                          ...
                          return ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return GestureDetector(
                                  onTap: () {
                                    if (vehicleType
                                        .contains(myData[index]['modify'])) {
                                      setState(() {
                                        vehicleType
                                            .remove(myData[index]['modify']);
                                      });
                                    } else {
                                      setState(() {
                                        vehicleType
                                            .add(myData[index]['vehicle']);
                                      });
                                    }
                                  },
                                  child: Padding(
