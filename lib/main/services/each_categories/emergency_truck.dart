...
class EmergencyTruck extends StatefulWidget {
  EmergencyTruck({Key key}) : super(key: key);

  @override
  _EmergencyTruckState createState() => _EmergencyTruckState();
}

class _EmergencyTruckState extends State<EmergencyTruck> {
  List vehicleType = [];
