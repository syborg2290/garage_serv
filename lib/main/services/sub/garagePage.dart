...
class GaragePage extends StatefulWidget {
  ...
  GaragePage({this.garage, this.docId, this.currentUser, Key key})
      : super(key: key);
              ...
              child: Container(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Text(
                      "Repairing vehicle types of " + widget.garage.garageName,
                      textAlign: TextAlign.center,
                      style: TextStyle(fontSize: 18),
                    ),
                    snapGarage == null
                                                                  ...
                                                                  children: <
                                                                    ...
                                                                    snapRepairPrice[snapGarage.preferredRepair[index]] ==
                                                                        ...
                                                                        ? SizedBox
                                                                            .shrink()
                                                                        : Text(
                                                                            snapRepairPrice[snapGarage.preferredRepair[index]][index2].toString() == null
                                                                                ? "It's depend"
                                                                                : widget.garage.currencyType + " " + snapRepairPrice[snapGarage.preferredRepair[index]][index2].toString(),
                                                                            textAlign:
                                                                                TextAlign.center,
                                                                            style:
                                                                                TextStyle(
                                ...
                                GestureDetector(
                                  ...
                                  child: Image.asset(
                                    likes == null
                                        ...
                                        : likes.contains(widget.currentUser.id)
