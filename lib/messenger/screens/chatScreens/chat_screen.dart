...
import 'package:garage/messenger/chat_config/firebase_configs.dart';
import 'package:garage/messenger/chat_models/chat_user.dart';
import 'package:garage/messenger/chat_models/message.dart';
import 'package:garage/messenger/constants/strings.dart';
import 'package:garage/messenger/enum/view_state.dart';
import 'package:garage/messenger/provider/image_upload_provider.dart';
...
import 'package:garage/messenger/resources/storage_methods.dart';
...
import 'package:garage/messenger/utills/call_utillities.dart';
...
import 'package:garage/messenger/widgets/chatAppBar.dart';
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void initState() {
    ...
    _authenticationMethods.getCurrentUser().then((user) {
      ...
      getUserObj(user.uid).then((value) {
        User userMain = User.fromDocument(value);
        setState(() {
          sender = ChatUser(
            uid: user.uid,
            name: userMain.username,
            profilePhoto: userMain.userPhotoUrl,
          );
        });
      });
    });
