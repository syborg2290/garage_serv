...
import 'package:garage/messenger/widgets/custom_notification_dialog.dart';
import 'package:garage/messenger/widgets/mainAppbar_style.dart';
import 'package:garage/messenger/widgets/user_circle.dart';
...
class MainAppBar extends StatelessWidget {
  ...
  const MainAppBar(
      {Key key, this.currentMainUser, this.title, this.back, this.initials})
      : super(key: key);
      ...
      case "dashboard":
        {
          return Builder(
            builder: (context) => UserCircle(
              currentMainUser: currentMainUser,
            ),
          );
        }
      case "chatscreen":
      ...
      default:
        {
          ...
          Navigator.of(context).push(MaterialPageRoute(
              builder: (BuildContext context) => Dashboard(
                    currentuserMain: currentMainUser,
                  )));
        }
        break;
    }
