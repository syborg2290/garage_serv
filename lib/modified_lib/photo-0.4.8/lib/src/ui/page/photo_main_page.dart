...
import 'package:garage/modified_lib/photo-0.4.8/lib/src/engine/lru_cache.dart';
import 'package:garage/modified_lib/photo-0.4.8/lib/src/engine/throttle.dart';
...
import 'package:garage/modified_lib/photo-0.4.8/lib/src/provider/gallery_list_provider.dart';
import 'package:garage/modified_lib/photo-0.4.8/lib/src/provider/i18n_provider.dart';
import 'package:garage/modified_lib/photo-0.4.8/lib/src/provider/selected_provider.dart';
import 'package:garage/modified_lib/photo-0.4.8/lib/src/ui/dialog/change_gallery_dialog.dart';
import 'package:garage/modified_lib/photo-0.4.8/lib/src/ui/page/photo_preview_page.dart';
...
class _PhotoMainPageState extends State<PhotoMainPage>
  ...
  String get currentGalleryName {
    ...
    return currentPath?.name ?? "Gallery folders";
  }
